...
class SystemSampler(BaseSampler):
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f"[TraceML] WARNING: psutil.cpu_percent initial call failed: {e}", file=sys.stderr)
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        try:
            if self.cpu_samples:
                summary["cpu_average_percent"] = round(sum(self.cpu_samples) / len(self.cpu_samples), 2)
            ...
            return {"error": str(e), "total_system_samples": 0}  # Return error with basic info
